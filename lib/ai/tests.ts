...
export async function resolveAiTestTemplateForAttempt(params: {
  ...
  const { output, provenance, debug } = await generateStructuredJson({
    ...
    systemInstruction: [
      ...
      "Each question must use these exact field names only:",
      ...
      "Generate questions from course-level concepts and skills based on:",
      "- course title",
      "- course description",
      "- resource metadata",
      "- resource summaries if available",
      ...
      "This test should feel like a university final exam, not a lightweight quiz.",
      "Questions should require meaningful understanding of the lesson and should not be too easy.",
      "Passing should require fairly deep understanding of the course content.",
      "Question design principles are mandatory:",
      "- practice-oriented",
      "- operationally specific",
      "- case-driven",
      "- deeper than simple recall",
      "Avoid too many definition-only questions.",
      "Do not generate many easy memorization questions.",
      "Prefer questions that require:",
      "- code reading",
      "- output interpretation",
      "- debugging",
      "- API/tool selection",
      "- choosing the correct implementation logic",
      "- applying concepts in a concrete scenario",
      "For multiple_choice:",
      "prefer scenario-based prompts with code snippets, command lines, logs, outputs, workflow decisions, or realistic problem situations.",
      "For fill_blank:",
      "prefer executable or meaningful tokens such as function names, parameters, clauses, code fragments, pipeline steps, or syntax elements used in real work.",
      "For short_answer:",
      "these must behave like real exam big questions.",
      "They should ask for practical problem solving, such as:",
      "- completing a function",
      "- fixing a bug",
      "- writing key logic",
      "- explaining how to solve a realistic task",
      "- explaining why code fails and how to correct it",
      "For coding-related lessons, especially Python, short_answer questions should strongly prefer:",
      "- function completion",
      "- code correction",
      "- logic implementation",
      "- debugging tasks",
      "Short_answer questions must not be vague essays.",
      "They must be concrete, practical, and solvable using lesson knowledge.",
